...
2. **Verify every DoD/AC item individually.** Run each `aitm-verified cmd="…"` in Develop/Test (`### Verification Commands`). Review stamps reuse a valid Test receipt or refuse; they never execute. Never bulk-check.
