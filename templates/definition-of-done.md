<!--
Each item below MUST be individually verified by inspection AND by running the relevant
test/build/command. Do not bulk-check. Do not preemptively check. See
