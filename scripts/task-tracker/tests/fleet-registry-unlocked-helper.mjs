...
import { fleetRegistryPath, readFleet, writeFleet, findMainWorktreePath } from '../fleet-registry.mjs';
...
fleet[issueRef] = { worktreePath: `/tmp/wt-${issueRef.replace('#', '')}`, branch, startedAt: new Date().toISOString(), status: 'active' };
