...
// #459 — Bug A: partial-success detection when gh prints a URL but exits nonzero.
...
`;
  ...
  // Tether must NOT have been called — the issue creation was partial.
  assert.equal(
...
// #459 — Bug A: genuine failure (no URL in stdout) still exits nonzero, no false-positive partial-success message.
