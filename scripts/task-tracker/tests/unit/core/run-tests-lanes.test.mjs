...
function fixture() {
  ...
  mk('scripts/co-located.test.mjs'); // co-located → unit by construction
...
test('#864: laneFiles("unit") resolves to only the unit section', () => {
  ...
  assert.deepEqual(unit, ['scripts/co-located.test.mjs', 'scripts/tests/unit/alpha.test.mjs']);
  assert.ok(
