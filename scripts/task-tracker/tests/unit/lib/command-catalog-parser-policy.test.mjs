...
import { commandByName } from '../../../lib/command-surface/catalog.mjs';
import { VERB_REFERENCE } from '../../../verbs/help-data.mjs';
import { VALID_KINDS } from '../../../lib/issue-kind.mjs';
...
test('maintenance and package metadata reject retired routes and expose parser defaults', () => {
  ...
  const source = readFileSync(
    new URL('../../../../../scripts/migrate/options-co-pilot-status-swap.mjs', import.meta.url),
    'utf8'
  );
