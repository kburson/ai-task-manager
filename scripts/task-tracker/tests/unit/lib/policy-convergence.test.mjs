  ...
  const fixtures = {
    ...
    'fixtures/nested-regexes.mjs': `
      const patterns = [
        ...
        enabled ? /'develop','test','review'/ : /'backlog','on-deck','refine'/,
      ];
    `,
    ...
    'fixtures/template-states.mjs': `
      const states = [
        \`backlog\`, \`on-deck\`, \`refine\`, \`plan\`,
        \`develop\`, \`test\`, \`review\`, \`done\`,
      ];
    `,
    'fixtures/interpolated-template-then-data.mjs': `
      const documentation =
        \`'backlog','on-deck','refine','plan',\${suffix},'develop','test','review','done'\`;
      const commands = {
        start: 'verbs/start.mjs',
        review: 'verbs/review.mjs',
      };
    ...
    'fixtures/nested-template-then-data.mjs': [
      "const documentation = `example ${`'backlog','on-deck','refine','plan','develop','test','review','done'`}`;",
