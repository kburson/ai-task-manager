...
//
// These tests pin the fix: `resolvesAsMain` calls realpath on both sides
// before comparing, with an injectable `realpath` so the symlink case is
// exercised without a live symlink on disk.
...
test('returns true when the .bin symlink realpath-resolves to the module file', () => {
