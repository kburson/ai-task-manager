...
// DEFAULT-ALLOWs on ambiguity. See maintenance/lint-test-coverage-reach-detector.mjs.
...
} from '../../../../maintenance/lint-test-coverage-reach-detector.mjs';

// This test moved one directory deeper (tests/unit → tests/unit/maintenance);
// offset the dir anchor back up so HERE-relative paths resolve to their originals.
