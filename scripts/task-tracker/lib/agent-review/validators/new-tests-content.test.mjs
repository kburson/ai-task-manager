...
import { validate } from './new-tests-content.mjs';
import {
  buildNewAutomatedTestsComment,
  NEW_TESTS_HEADING,
  NEW_TESTS_FOOTER,
} from '../../new-automated-tests-comment.mjs';
...
const WELL_FORMED = buildNewAutomatedTestsComment([
  {
    file: 'scripts/task-tracker/lib/agent-review/validators/new-tests-content.test.mjs',
