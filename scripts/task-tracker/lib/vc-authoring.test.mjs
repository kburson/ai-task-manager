...
import { citeCommands, resolveVcRefCommands } from './vc-ref.mjs';
import { buildEvidenceBackfill, parseEvidenceChecklist } from './evidence-markers.mjs';
...
import { autoTickVerified } from './auto-tick-verified.mjs';
