...
export const VERB_CONTRACTS = Object.freeze({
  ...
  close: contract(
    ...
    [
      ...
      'False-delivery restart writes and reads back immutable correction evidence before replacing the completed protected marker with a same-SHA zero-step transaction and resuming the ordinary close saga. It preserves the old transaction and no-commit record and is not a generic delivery backfill.',
    ],
