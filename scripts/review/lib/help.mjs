...
export const COMMANDS = Object.freeze({
  start: command({
    ...
    prerequisites: [
      ...
      'Host archive policy is optional, but --issue and --artifact-kind must be supplied together; kind is exactly spec or plan.',
    ],
    usage:
      'npx aitm co-review start [--artifact <repo-path> --owner <author-identity> --reviewer <reviewer-identity>] [--issue <N> --artifact-kind <spec|plan>] [--dir <ignored-path>] [--max-turns <N>] [--wait-cycles <N>] [--wait-interval <seconds>]',
    arguments: [
    ...
    effects: [
      ...
      'With paired host context, derives docs/superpowers/reviews/<issue>/<spec|plan>/ and configures that exact archive destination through init and both handoffs.',
    ...
    validations: [
      ...
      'Partial or invalid host context refuses before initialization; artifact kind is never guessed from the artifact filename.',
