...
export const TIMING_EVENT_BASELINE = Object.freeze({
  ...
  emitters: Object.freeze([
    ...
    timingEmitter('scripts/task-tracker/verbs/approve.mjs', 412, 'event-call', "'lifecycle-warn'", [
      'lifecycle-warn',
    ]),
    timingEmitter(
    ...
    timingEmitter('scripts/task-tracker/verbs/close.mjs', 2070, 'event-call', "'lifecycle-warn'", [
      'lifecycle-warn',
    ]),
    timingEmitter(
      'scripts/task-tracker/verbs/close.mjs',
    ...
    timingEmitter('scripts/task-tracker/verbs/resume.mjs', 239, 'event-call', "'resumed'", [
      'resumed',
    ]),
    timingEmitter(
    ...
    timingEmitter('scripts/task-tracker/verbs/resume.mjs', 490, 'event-call', 'bindEvent', [
      'start',
      'resumed',
    ]),
    ...
    timingEmitter('scripts/task-tracker/verbs/review.mjs', 869, 'event-call', "'gate-refused'", [
      'gate-refused',
    ]),
