...
export const TIMING_EVENT_BASELINE = Object.freeze({
  ...
  emitters: Object.freeze([
    ...
    timingEmitter('scripts/task-tracker/hook-handler.mjs', 295, 'event-spec', "'resumed'", [
      'resumed',
    ]),
    timingEmitter('scripts/task-tracker/hook-handler.mjs', 473, 'event-call', "'session-start'", [
      'session-start',
    ]),
    ...
    timingEmitter('scripts/task-tracker/verbs/approve.mjs', 404, 'event-call', "'lifecycle-warn'", [
      'lifecycle-warn',
    ]),
    timingEmitter(
    ...
    timingEmitter('scripts/task-tracker/verbs/close.mjs', 1160, 'event-call', "'lifecycle-warn'", [
      'lifecycle-warn',
    ]),
    timingEmitter(
      'scripts/task-tracker/verbs/close.mjs',
    ...
    timingEmitter('scripts/task-tracker/verbs/review.mjs', 618, 'event-call', "'review:failed'", [
      'review:failed',
    ]),
    timingEmitter('scripts/task-tracker/verbs/review.mjs', 659, 'event-call', "'review:passed'", [
      'review:passed',
    ]),
    timingEmitter('scripts/task-tracker/verbs/review.mjs', 695, 'event-call', "'test:failed'", [
      'test:failed',
    ]),
    ...
    timingEmitter('scripts/task-tracker/verbs/switch.mjs', 104, 'flush-call', 'eventSlug', [
      'switch-out:#1007',
    ]),
    timingEmitter('scripts/task-tracker/verbs/switch.mjs', 221, 'event-call', 'bindEvent', [
      'start',
      'resumed',
    ]),
