...
//
// vc:2 = node --test scripts/tests/unit/task-tracker/run-move-state-timeout.test.mjs
...
test('#764: runtime.mjs drives the move in-process (no move-state child spawn to SIGTERM-kill)', () => {
  const src = readFileSync(
    fileURLToPath(new URL('../../../../task-tracker/runtime.mjs', import.meta.url)),
    'utf8'
  );
