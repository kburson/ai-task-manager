...
} from '../../../../task-tracker/lib/epic-ac-child-bijection.mjs';
...
test('the report is wired into epic-reconcile and cannot break the stamp', () => {
  const src = readFileSync(
    new URL('../../../../task-tracker/verbs/epic-reconcile.mjs', import.meta.url),
    'utf8'
  );
...
test('the module registers no state-machine guard — it refuses nothing', () => {
  const review = readFileSync(
    new URL('../../../../task-tracker/states/review.mjs', import.meta.url),
    'utf8'
  );
