...
import {
  ...
  parseRowTs,
  parseTimingRows,
} from '../../../../task-tracker/lib/timing-ladder.mjs';
import { EVENT_CLASS } from '../../../../task-tracker/lib/timing-events/index.mjs';

// The exact historical #625 timing fixture (19 rows), CDT (-05:00)
// throughout. Its legacy second-stage row proves read compatibility.
const FIXTURE = [
