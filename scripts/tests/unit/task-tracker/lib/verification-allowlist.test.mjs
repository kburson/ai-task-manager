...
import { validateVerificationCommand } from '../../../../task-tracker/lib/verification-allowlist.mjs';
...
const accepts = [
  ...
  [
    'node scripts/tests/unit/task-tracker/state.test.mjs',
    ['node', 'scripts/tests/unit/task-tracker/state.test.mjs'],
  ],
...
const canonicalCases = [
  'npm test',
  'npm test -- scripts/tests/unit/task-tracker/verification-allowlist.test.mjs',
  'npm run lint',
