...
import { backwardTargets } from '../../../../../task-tracker/lib/lifecycle-policy/index.mjs';
...
const VERB_MODULES = {
  shelve: () => import('../../../../../task-tracker/verbs/shelve.mjs'),
  park: () => import('../../../../../task-tracker/verbs/park.mjs'),
  demote: () => import('../../../../../task-tracker/verbs/demote.mjs'),
};
...
test('demote is unaffected by #848: still hardcoded to develop, from test/review only', async () => {
  const { DEMOTE_TARGET, LEGAL_FROM } =
    await import('../../../../../task-tracker/verbs/demote.mjs');
