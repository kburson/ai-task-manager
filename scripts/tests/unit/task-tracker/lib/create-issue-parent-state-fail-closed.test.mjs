...
import { decideParentStateReadFailure } from '../../../../task-tracker/lib/parent-state-gate.mjs';

const __dirname = path.dirname(fileURLToPath(import.meta.url)) + '/..';
const createSrc = readFileSync(path.resolve(__dirname, '../../../gh/create-issue.mjs'), 'utf8');
