...
import {
  ...
  serializeConfig,
  writeConfig,
} from '../../../../../task-tracker/lib/config-init/config-authoring.mjs';
import {
  TASK_TEMPLATE,
  BUG_TEMPLATE,
  ISSUE_TEMPLATES,
  writeIssueTemplates,
} from '../../../../../task-tracker/lib/config-init/issue-templates.mjs';
import {
...
test('init-project-config.sh delegates config + template writes to config-init.mjs', () => {
  const sh = readFileSync(path.resolve(__dirname, '../../../gh/init-project-config.sh'), 'utf8');
