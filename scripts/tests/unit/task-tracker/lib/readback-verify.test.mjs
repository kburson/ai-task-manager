...
} from '../../../../task-tracker/lib/stamp-verify.mjs';
import { shouldEmitReviewApprovedRow } from '../../../../task-tracker/lib/close-convergence.mjs';
import { hasReviewApprovedMarker } from '../../../../task-tracker/lib/markers.mjs';
...
const approveSrc = readFileSync(
  path.resolve(__dirname, '../../../task-tracker/verbs/approve.mjs'),
  'utf8'
);
