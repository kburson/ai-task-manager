...
const SRC_PATH = path.resolve(__dirname, '../../../task-tracker/verbs/close.mjs');
const SRC = readFileSync(SRC_PATH, 'utf8');
const PREFLIGHT_SRC = readFileSync(
  path.resolve(__dirname, '../../../task-tracker/lib/verb-preflight.mjs'),
  'utf8'
);
const CLI = path.resolve(__dirname, '../../../task-tracker/task-tracker.mjs');
