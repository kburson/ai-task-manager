...
import { hasNoNewTestsDeclaration } from '../../../../task-tracker/lib/issue-kind.mjs';
import {
  upsertNoNewTestsMarker,
  declareNoNewTests,
} from '../../../../task-tracker/lib/no-new-tests-declaration.mjs';
...
describe('declareNoNewTests — mutateIssueBody-routed (#944)', () => {
  it('routes the write through the injected mutateIssueBody and stamps the marker', async () => {
    ...
    const res = await declareNoNewTests({
      ...
      guardedBy: 'scripts/tests/unit/task-tracker/quality-config.test.mjs',
