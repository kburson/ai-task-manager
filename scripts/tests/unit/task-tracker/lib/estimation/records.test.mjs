...
} from '../../../../../task-tracker/lib/estimation/forecast-record.mjs';
import {
  OUTCOME_RECORD_TYPE,
  validateEstimationOutcome,
} from '../../../../../task-tracker/lib/estimation/outcome-record.mjs';
import {
  RUBRIC_RECORD_TYPE,
  validateEstimationRubric,
} from '../../../../../task-tracker/lib/estimation/rubric-record.mjs';
import { createGitHubEstimationRecordIo } from '../../../../../task-tracker/lib/estimation/runtime-adapter.mjs';
import {
  renderEstimationForecast,
  renderEstimationOutcome,
  renderEstimationRubric,
  writeEstimationRecord,
} from '../../../../../task-tracker/lib/estimation/renderers.mjs';
import {
...
test('production estimation transport uses the #1070 store without direct REST comment code', () => {
  const source = readFileSync(
    new URL('../../../../../task-tracker/lib/estimation/runtime-adapter.mjs', import.meta.url),
    'utf8'
  );
