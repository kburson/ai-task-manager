...
import { buildFinalSteps, buildIterationSteps } from '../../../../task-tracker/verify-develop.mjs';

const HERE = path.dirname(fileURLToPath(import.meta.url));
const ROOT = path.resolve(HERE, '../../../../..');
const fixture = JSON.parse(
  readFileSync(
    path.join(ROOT, 'scripts/tests/fixtures/verification/stage-command-classifications.json'),
    'utf8'
  )
);
