...
import {
  decideBodyFetchFailure,
  BODY_GATED_STATES,
} from '../../../../task-tracker/lib/body-fetch-gate.mjs';

const __dirname = path.dirname(fileURLToPath(import.meta.url)) + '/..';
const moveSrc = readFileSync(path.resolve(__dirname, '../../../gh/move-state.mjs'), 'utf8');
...
const guardSrc = readFileSync(
  path.resolve(__dirname, '../../../task-tracker/lib/move-state/guard-execution.mjs'),
  'utf8'
);
