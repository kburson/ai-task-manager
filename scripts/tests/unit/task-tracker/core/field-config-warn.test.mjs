...
} from '../../../../task-tracker/lib/field-config-warn.mjs';
import { writeBlockedByField } from '../../../../task-tracker/lib/blocked-by-field.mjs';
import { stampStartTime } from '../../../../task-tracker/lib/stamp-start-time.mjs';
...
test('#342 — every WELL_KNOWN_FIELD_KEY is enumerated in config.mjs DEFAULTS', async () => {
  const { DEFAULTS } = await import('../../../../task-tracker/config.mjs');
...
test('#342 — fresh-init cfg fixture populates every WELL_KNOWN_FIELD_KEY via fieldIds auto-mirror', async () => {
  ...
  const { mkdtempProjectIsolated } = await import('../../../../task-tracker/lib/scratch-dir.mjs');
