...
//
// <!-- aitm-defect-repro-test: scripts/tests/unit/task-tracker/source-edit-post-develop-lock.test.mjs -->

import { strict as assert } from 'node:assert';
import { test } from 'node:test';
import { decideSourceEdit } from '../../../../task-tracker/source-edit-gate.mjs';

const PROJECT_DIR = '/tmp/aitm-805-project';
const SOURCE = 'src/foo.mjs'; // classifyEdit → WRITE_CODE
const REGRESSION = 'scripts/tests/unit/task-tracker/close-flush-timing.test.mjs'; // WRITE_CODE
