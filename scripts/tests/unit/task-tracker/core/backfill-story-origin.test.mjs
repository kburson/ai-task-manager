...
import { buildPlanMetadataBackfill } from '../../../../task-tracker/backfill-plan-metadata.mjs';
...
describe('buildPlanMetadataBackfill Story Origin migration (#892)', () => {
  ...
  it('replaces comment-only Story Origin placeholders with populated legacy values', () => {
    const body = [
      '## Story Origin',
      '',
      '- **kind**: code',
