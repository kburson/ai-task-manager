...
import {
  ...
  planStageHeal,
  safeBackfillTs,
} from '../../../../task-tracker/heal-entry-markers.mjs';
import {
...
test('verifyChainIntegrity passes after restamping out-of-order test (full round-trip)', async () => {
  const { backfillEntryMarker } =
    await import('../../../../task-tracker/lib/stage-entry-markers.mjs');
  const { stripStageMarkers } = await import('../../../../task-tracker/heal-entry-markers.mjs');
  const body = bodyWith([
    ['refine', '2026-05-18T10:00:00Z'],
    ['ready-for-plan', '2026-05-18T10:30:00Z'],
    ['plan', '2026-05-18T11:00:00Z'],
