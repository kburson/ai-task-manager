...
| [root-plans/task-lifecycle-master-plan.md](./root-plans/task-lifecycle-master-plan.md)                 | Historical task lifecycle design before the current seven-state vocabulary settled.                              |
