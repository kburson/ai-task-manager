...
| Workflow control         | Moves issues through Backlog, Assigned, Refine, Plan, Develop, Test, Review, and Done with gates       | Prevents agents from skipping analysis, tests, or human approval |
