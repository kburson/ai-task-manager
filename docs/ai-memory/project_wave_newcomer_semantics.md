...
---
In the 7-state kanban Sequence-driven wave model (issue #41 epic), when a deep-dive discovers a new sub-issue and slots it into the *current* wave (same `Sequence` as already-flowing members), the gate behavior is asymmetric:
