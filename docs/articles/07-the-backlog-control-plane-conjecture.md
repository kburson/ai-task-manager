...
![The Backlog Becomes The Control Plane](assets/article-headers/article-07-header.png)
...
The backlog is the control surface I rely on for this. Next, [The Just-In-Time Planner](08-the-just-in-time-planning-paradox.md) covers how that surface decomposes large intent into atomic work at the right time.
...
| **Current** | **07** | **[The Backlog Becomes The Control Plane](07-the-backlog-control-plane-conjecture.md)** | Backlog as executable control surface |
