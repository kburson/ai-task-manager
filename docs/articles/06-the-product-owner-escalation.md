...
![The Rise Of The Technical Product Owner](assets/article-headers/article-06-header.png)
...
I've walked through the human operator I became. Next, in [The Backlog Becomes The Control Plane](07-the-backlog-control-plane-conjecture.md), I explain the artifact that operator uses to govern the fleet.
...
| **Current** | **06** | **[The Rise Of The Technical Product Owner](06-the-product-owner-escalation.md)** | Human operator: TPO/TPM as delivery architect |
