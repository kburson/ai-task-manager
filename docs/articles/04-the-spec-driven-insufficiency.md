...
This article explains why specs need an execution layer underneath them, the layer I had to build for myself. The next article, [Regeneration Is Cheap. Hardening Isn't. Guess Which One Gets Skipped.](05-easy-come-easy-go.md), shows what happens when that layer is missing and the spec keeps moving anyway.
