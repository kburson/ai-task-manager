...
![The Adapter Future](assets/article-headers/article-11-header.png)
...
This article moves from AITM as a local pattern to AITM as an integration argument. The next article, [XP's Practices Survived. Their Reasons Did Not.](13-the-xp-survival-anomaly.md), shifts from architecture and adapters into the day-to-day mechanics of running agentic delivery at scale. Or return to the [Research Synopsis](research-synopsis.md) for the evidence map and source taxonomy, or start over at [The Rise Of Technical Product Operations](02-the-backlog-governance-postulate.md).
...
| **Current** | **11** | **[The Adapter Future](11-the-adapter-convergence.md)**                                                            | Backlog and agent platform adapters                  |
