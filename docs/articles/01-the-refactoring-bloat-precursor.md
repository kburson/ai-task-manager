...
ReSharper never touched JavaScript in any serious way, and it was never a JetBrains IDE feature — it was bolted onto _Microsoft's_ IDE. JetBrains' own IDEs (IntelliJ IDEA, WebStorm) shipped that inspection engine natively; ReSharper was JetBrains porting the same idea into somebody else's editor.
