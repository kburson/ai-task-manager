...
- Protocol directory: `".scratch/co-review/1219-continuous-agent-delivery-spec-only-restart"`
- Absolute protocol directory: `"/Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart"`
- Protocol ID: `"c1655cdd-f0c8-48fd-95e3-57af190d9f0c"`
- Authoritative artifact: `"docs/superpowers/specs/2026-09-04-1219-continuous-agent-delivery-amendment-design.md"`
- Author identity: `"codex"`
- Reviewer identity: `"claude"`
- Claim provenance profile: `"provider-session/v1"`
- Host issue: 1219
- Artifact kind: `"spec"`
- Archive destination: `"docs/superpowers/reviews/1219/spec"`
...
```text
npx aitm co-review status --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart
```
...
```text
npx aitm co-review status --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart --json
```
...
```text
npx aitm co-review wait --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart --actor codex --timeout 60
```
...
The repository host configured `"docs/superpowers/reviews/1219/spec"` for this `"spec"` review. After acceptance, including an exit-code-4 publication failure, use this exact explicit finalization command:

```text
npx aitm co-review finalize --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart --archive-dir docs/superpowers/reviews/1219/spec
```
...
```text
npx aitm co-review claim --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart --actor codex
```
...
When changes are required, edit and commit only `"docs/superpowers/specs/2026-09-04-1219-continuous-agent-delivery-amendment-design.md"`. Before handoff, verify the artifact, index, committed blob, and response bytes. Then use the concrete current response path, commit, optional answers file, and message with:

```text
npx aitm co-review handoff --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart --actor codex --response /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart/round-N-author-response.md --artifact docs/superpowers/specs/2026-09-04-1219-continuous-agent-delivery-amendment-design.md --commit COMMIT_SHA --message 'author response complete'
```
...
```text
npx aitm co-review handoff --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart --actor codex --response /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-only-restart/round-N-author-response.md --answers REVIEW_PATH --artifact docs/superpowers/specs/2026-09-04-1219-continuous-agent-delivery-amendment-design.md --commit COMMIT_SHA --message 'author response complete'
```
