...
- Protocol directory: `".scratch/co-review/1219-continuous-agent-delivery-spec-claude"`
- Absolute protocol directory: `"/Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude"`
- Protocol ID: `"3bd127b5-a3c9-4dfc-bda0-3882261b2788"`
...
```text
npx aitm co-review status --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude
```
...
```text
npx aitm co-review status --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude --json
```
...
```text
npx aitm co-review wait --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude --actor codex --timeout 60
```
...
```text
npx aitm co-review finalize --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude --archive-dir docs/superpowers/reviews/1219/spec
```
...
```text
npx aitm co-review claim --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude --actor codex
```
...
```text
npx aitm co-review handoff --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude --actor codex --response /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude/round-N-author-response.md --artifact docs/superpowers/specs/2026-09-04-1219-continuous-agent-delivery-amendment-design.md --commit COMMIT_SHA --message 'author response complete'
```
...
```text
npx aitm co-review handoff --dir /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude --actor codex --response /Users/kpburson/projects/Vibe-Coding/ai-task-manager/.worktrees/1219-cloud-test-automation/.scratch/co-review/1219-continuous-agent-delivery-spec-claude/round-N-author-response.md --answers REVIEW_PATH --artifact docs/superpowers/specs/2026-09-04-1219-continuous-agent-delivery-amendment-design.md --commit COMMIT_SHA --message 'author response complete'
```
