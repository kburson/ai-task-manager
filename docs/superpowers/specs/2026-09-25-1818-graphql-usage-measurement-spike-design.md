...
evidence for [epic #1817](https://github.com/kburson/ai-task-manager/issues/1817),
which is natively blocked by this spike. The standalone
[Backlog story is #1818](https://github.com/kburson/ai-task-manager/issues/1818).
Before implementation starts, refine #1818 through the governed AITM workflow,
with Size and Estimate set. The specification was reviewed before story creation.
