...
**Status:** Revised after replacement-plan round 2 (P2-01 and P2-02); all four round-1 findings are reviewer-confirmed closed. Awaiting reviewer confirmation of this revision. The round-2 author response is `docs/superpowers/reviews/1558/plan/2026-09-16-replacement-round-2-author-codex.md`. The user's instruction authorizes drafting from the agreed amended spec; it does not approve this replacement plan, hydrate issues, or authorize implementation. Preserve source-spec and historical review bytes, including their historical status wording.
