> Human reference preserved during #1773 protocol slimming. Current CLI results and `rules/state-walk.md` govern actions; the detail below is not automatically loaded instruction authority.
