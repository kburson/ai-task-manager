> Human reference preserved during #1773 protocol slimming. Current CLI results and `rules/bind.md` govern actions; the detail below is not automatically loaded instruction authority.
