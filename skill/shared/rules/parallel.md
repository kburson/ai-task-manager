...
| `HUMAN_APPROVED`         | Human explicitly instructed close. Set by the human, not the subagent.                                                                                                           | Run `/task close <N>`. Count as Done. Advance sequence only after every sequence-issue is Done.                   |
